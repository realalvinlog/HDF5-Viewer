...
- 内置可视化插件（折线图、热力图、直方图）为 **ASCII 文本渲染**，非图形化图表
- 插件按钮（🔌）在 Activity Bar 上存在，但**无对应面板 UI**，插件仅通过代码 API 调用
- 标签拖拽成独立窗口**未实现**（信号已定义但未连接处理）
- Command Palette、主题配置**未实现**
